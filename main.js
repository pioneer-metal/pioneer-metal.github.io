...
const i18nData = {
    en: {
        ...
        "story-t": "Manufacturing <span class='text-white/70'>Power</span>",
        ...
        // Products Page
        "prod-tag": "Our Expertise", "prod-header": "Precision Solutions", "prod-intro": "Engineered for excellence. We deliver high-performance steel profiles designed to exceed international standards.",
        ...
        // News Page
        "news-tag": "Our Updates",
        "news-header": "Latest Insights",
    ...
    es: {
        ...
        "story-t": "Poder de <span class='text-white/70'>Fabricación</span>",
        ...
        // Products Page
        "prod-tag": "Nuestra Experiencia", "prod-header": "Soluciones de Precisión", "prod-intro": "Diseñado para la excelencia. Entregamos perfiles de acero de alto rendimiento.",
        ...
        "btn-catalog": "DESCARGAR CATÁLOGO", "btn-coming-soon": "PRÓXIMAMENTE", "btn-inquiry": "CONSULTAR AHORA",
        "news-tag": "Actualizaciones", "news-header": "Últimas Perspectivas", "news-subheader": "Manténgase al día con los avances industriales y los eventos globales de Pioneer Metal.",
    ...
    pt: {
        ...
        "bg-promise": "PROMESSA",
        "about-quote": "\"A precisão não é apenas um padrão,<br><span class='font-bold text-red-500'>é nossa promessa.</span>\"",
        "story-t": "Poder de <span class='text-white/70'>Fabricação</span>", "story-d1": "Nossa fábrica é equipada com linhas de produção automatizadas monitoradas por engenheiros experientes.",
        "stat-exp": "Anos de Experiência", "stat-tons": "Toneladas Anuais",
        // Products Page
        "prod-tag": "Nossa Especialidade", "prod-header": "Soluções de Precisão", "prod-intro": "Projetado para a excelência. Entregamos perfis de aço de alto desempenho.",
        ...
        "btn-catalog": "BAIXAR CATÁLOGO", "btn-coming-soon": "EM BREVE", "btn-inquiry": "SOLICITAR COTAÇÃO",
        "news-tag": "Atualizações", "news-header": "Últimos Insights", "news-subheader": "Fique atualizado com os avanços industriais e destaques de feiras globais.",
    ...
    ru: {
        ...
        "story-t": "Мощность <span class='text-white/70'>Производства</span>", "story-d1": "Наш завод оснащен современными автоматизированными линиями под контролем опытных инженеров.",
        "stat-exp": "Лет Опыта", "stat-tons": "Тонн в Год",
        // Products Page
        "prod-tag": "Наша Экспертиза", "prod-header": "Прецизионные Решения", "prod-intro": "Создано для совершенства. Мы поставляем высококачественные стальные профили.",
        ...
        "btn-catalog": "СКАЧАТЬ КАТАЛОГ", "btn-coming-soon": "СКОРО", "btn-inquiry": "УЗНАТЬ ЦЕНУ",
        "news-tag": "Обновления", "news-header": "Последние инсайты", "news-subheader": "Следите за промышленными достижениями и мировыми выставками Pioneer Metal.",
    ...
    ja: {
        ...
        "story-t": "製造の <span class='text-white/70'>力</span>", "story-d1": "当社の工場は高度な自動生产ラインを備えており、熟練したエンジニアが各工程を監視しています。",
        "stat-exp": "年間の経験", "stat-tons": "年間生产量",
        // Products Page
        "prod-tag": "当社の専門知識", "prod-header": "精密ソリューション", "prod-intro": "卓越性を追求した設計。国際基準を超える高性能な鋼製プロファイルをお届けします。",
        ...
        "btn-catalog": "カタログをダウンロード", "btn-coming-soon": "近日公開", "btn-inquiry": "今すぐお問い合わせ",
        "news-tag": "アップデート", "news-header": "最新の洞察", "news-subheader": "パイオニアメタルの産業進歩とグローバルな展示会のハイライトをご覧ください。",
    ...
    ko: {
        ...
        "story-t": "제조 <span class='text-white/70'>능력</span>", "story-d1": "당사 공장은 첨단 자동화 생산 라인을 갖추고 있으며 모든 공정은 숙련된 엔지니어가 모니터링합니다.",
        "stat-exp": "년의 경험", "stat-tons": "연간 생산량",
        // Products Page
        "prod-tag": "우리의 전문성", "prod-header": "정밀 솔루션", "prod-intro": "탁월함을 위한 설계. 국제 표준을 뛰어넘는 고성능 강철 프로파일을 제공합니다.",
        ...
        "btn-catalog": "카탈로그 다운로드", "btn-coming-soon": "커밍순", "btn-inquiry": "지금 문의하기",
        "news-tag": "업데이트", "news-header": "최신 인사이트", "news-subheader": "파이오니아 메탈의 산업 발전과 글로벌 전시회 소식을 확인하세요.",
    ...
    ar: {
        ...
        "story-t": "قوة <span class='text-white/70'>التصنيع</span>", "story-d1": "مصنعنا مجهز بخطوط إنتاج آلية متطورة. تتم مراقبة كل عملية من قبل مهندسين ذوي خبرة.",
        "stat-exp": "عاماً من الخبرة", "stat-tons": "طن سنوياً",
        // Products Page
        "prod-tag": "خبرتنا", "prod-header": "حلول دقيقة", "prod-intro": "مصممة للتميز. نحن نقدم قطاعات فولاذية عالية الأداء مصممة لتجاوز المعايير الدولية.",
        ...
        "btn-catalog": "تحميل الكتالوج", "btn-coming-soon": "قريباً", "btn-inquiry": "استفسر الآن",
        "news-tag": "تحديثاتنا", "news-header": "أحدث الرؤى", "news-subheader": "ابق على اطلاع بآخر التطورات الصناعية وأبرز المعارض العالمية لشركة بايونير ميتال.",
    ...
    fr: {
        ...
        "story-t": "Puissance de <span class='text-white/70'>Fabrication</span>",
        ...
        // Products Page
        "prod-tag": "Notre Expertise", "prod-header": "Solutions de Précision", "prod-intro": "Conçu pour l'excellence. Nous livrons des profilés en acier haute performance.",
        ...
        "btn-catalog": "TÉLÉCHARGER CATALOGUE", "btn-coming-soon": "BIENTÔT", "btn-inquiry": "DEMANDER PRIX",
        "news-tag": "Nos Mises à Jour", "news-header": "Dernières Perspectives", "news-subheader": "Restez informé des avancées industrielles et des expositions mondiales de Pioneer Metal.",
    ...
    sq: {
        ...
        "bg-promise": "PREMTIMI",
        "about-quote": "\"Precizioni nuk është thjesht standard,<br><span class='font-bold text-red-500'>është premtimi ynë.</span>\"",
        "story-t": "Fuqia e <span class='text-white/70'>Prodhimit</span>",
        ...
        // Products Page
        "prod-tag": "Ekspertiza Jonë", "prod-header": "Zgjidhje Precize", "prod-intro": "Inxhinieri për përsosmëri. Ofrojmë profile çeliku me performancë të lartë.",
        ...
        "btn-catalog": "SHKARKO KATALOGUN", "btn-coming-soon": "SË SHPEJTI", "btn-inquiry": "PYET TANI",
        "news-tag": "Përditësimet tona", "news-header": "Perspektivat e Fundit", "news-subheader": "Qëndroni të informuar me përparimet industriale të Pioneer Metal.",
    ...
    sr: {
        ...
        "story-t": "Moć <span class='text-white/70'>Proizvodnje</span>",
        ...
        // Products Page
        "prod-tag": "Naša Ekspertiza", "prod-header": "Precizna Rešenja", "prod-intro": "Dizajnirano za izvrsnost. Isporučujemo čelične profile visokih performansi.",
        ...
        "btn-catalog": "PREUZMI KATALOG", "btn-coming-soon": "USKORO", "btn-inquiry": "UPIT SADA",
        "news-tag": "Naša Ažuriranja", "news-header": "Najnoviji Uvidi", "news-subheader": "Budite u toku sa industrijskim napretkom kompanije Pioneer Metal.",
        ...
        "news2-d": "Širimo se u Južnu Ameriku! Pioneer Metal će predstaviti tehnologji u Sao Paulu.",
