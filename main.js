...
const i18nData = {
    en: {
        ...
        "coop-subtitle": "Partnership & Growth", "coop-title": "Business<br><span class='text-white/80'>Cooperation</span>",
        ...
        "stat-worldwide-tag": "Global Impact", "stat-worldwide-title": "Worldwide<br><span class='text-white/70'>Scale</span>", "stat-worldwide-desc": "Pioneer Metal's commitment to industrial excellence reaches every corner of the globe, delivering precision engineering at scale.",
    ...
    es: {
        ...
        "coop-subtitle": "Asociación y Crecimiento", "coop-title": "Cooperación<br><span class='text-white/80'>Empresarial</span>", "coop-desc": "Colaborando con empresas líderes a nivel mundial para proporcionar soluciones OEM personalizadas, logística superior e integración de sellado de alta resiliencia.",
        ...
        "stat-worldwide-tag": "Impacto Global", "stat-worldwide-title": "Escala<br><span class='text-white/70'>Mundial</span>", "stat-worldwide-desc": "El compromiso de Pioneer Metal con la excelencia industrial llega a todos los rincones del mundo, ofreciendo ingeniería de precisión a escala.",
        ...
        "story-t": "Poder de<br><span class='text-white/70'>Fabricación</span>", "story-d1": "Nuestra fábrica está equipada con líneas de producción automatizadas avanzadas. Integramos la ingeniería de precisión con la fabricación rápida para ofrecer soluciones de acero laminado en frío que definen los estándares de la industria.",
    ...
    pt: {
        ...
        "coop-subtitle": "Parceria & Crescimento", "coop-title": "Cooperação<br><span class='text-white/80'>Empresarial</span>", "coop-desc": "Colaborando com empresas líderes globais para fornecer soluções OEM personalizadas, logística superior e integração de vedação de alta resiliência.",
        ...
        "stat-worldwide-tag": "Impacto Global", "stat-worldwide-title": "Escala<br><span class='text-white/70'>Mundial</span>", "stat-worldwide-desc": "O compromisso da Pioneer Metal com a excelência industrial atinge todos os cantos do globo, oferecendo engenharia de precisão em escala.",
        ...
        "story-t": "Poder de<br><span class='text-white/70'>Fabricação</span>", "story-d1": "Nossa fábrica está equipada com linhas de produção automatizadas avançadas. Integramos engenharia de precisão com fabricação rápida para oferecer soluções de aço laminado a frio que definem os padrões da indústria.",
    ...
    ru: {
        ...
        "coop-subtitle": "Партнерство и Рост", "coop-title": "Бизнес<br><span class='text-white/80'>Сотрудничество</span>", "coop-desc": "Сотрудничество с ведущими мировыми предприятиями для предоставления индивидуальных OEM-решений, превосходной логистики и высокоэластичной герметизации.",
        ...
        "stat-worldwide-tag": "Глобальное Влияние", "stat-worldwide-title": "Мировой<br><span class='text-white/70'>Масштаб</span>", "stat-worldwide-desc": "Стремление Pioneer Metal к промышленному совершенству охватывает все уголки земного шара, обеспечивая высокоточное проектирование в масштабе.",
        ...
        "story-t": "Мощность<br><span class='text-white/70'>Производства</span>", "story-d1": "Наш завод оснащен современными автоматизированными производственными линиями. Мы интегрируем прецизионное проектирование с быстрым производством для предоставления холоднокатаных стальных решений, определяющих отраслевые стандарты.",
    ...
    ja: {
        ...
        "coop-subtitle": "パートナーシップと成長", "coop-title": "ビジネス<br><span class='text-white/80'>協力</span>", "coop-desc": "世界をリードする企業と協力して、カスタマイズされたOEMソリューション、優れた物流、高反発シーリングの統合を提供します。",
        ...
        "stat-worldwide-tag": "世界への影響", "stat-worldwide-title": "世界規模の<br><span class='text-white/70'>スケール</span>", "stat-worldwide-desc": "産業の卓越性に対するパイオニアメタルの取り組みは、世界のあらゆる隅々に届き、大規模な精密工学を提供しています。",
        ...
        "story-t": "製造の<br><span class='text-white/70'>力</span>", "story-d1": "当社の工場は、高度な自動生産ラインを備えています。精密工学と迅速な製造を統合し、業界標準を定義する冷間圧延鋼ソリューションを提供します。",
    ...
    ko: {
        ...
        "coop-subtitle": "파트너십과 성장", "coop-title": "비즈니스<br><span class='text-white/80'>협력</span>", "coop-desc": "글로벌 선도 기업들과 협력하여 맞춤형 OEM 솔루션, 우수한 물류 및 고탄성 실링 통합을 제공합니다.",
        ...
        "stat-worldwide-tag": "글로벌 영향력", "stat-worldwide-title": "세계적인<br><span class='text-white/70'>규모</span>", "stat-worldwide-desc": "산업적 탁월함에 대한 파이오니아 메탈의 약속은 전 세계 곳곳에 닿아 대규모 정밀 공학을 제공합니다.",
        ...
        "story-t": "제조의<br><span class='text-white/70'>힘</span>", "story-d1": "당사 공장은 첨단 자동화 생산 라인을 갖추고 있습니다. 정밀 공학과 신속한 제조를 통합하여 업계 표준을 정의하는 냉간 압연 강철 솔루션을 제공합니다.",
    ...
    ar: {
        ...
        "coop-subtitle": "الشراكة والنمو", "coop-title": "التعاون<br><span class='text-white/80'>التجاري</span>", "coop-desc": "التعاون مع الشركات الرائدة عالمياً لتقديم حلول OEM مخصصة، ولوجستيات متفوقة، وتكامل عزل عالي المرونة.",
        ...
        "stat-worldwide-tag": "تأثير عالمي", "stat-worldwide-title": "على نطاق<br><span class='text-white/70'>عالمي</span>", "stat-worldwide-desc": "يصل التزام بايونير ميتال بالتميز الصناعي إلى كل ركن من أركان العالم، مقدماً هندسة دقيقة على نطاق واسع.",
        ...
        "story-t": "قوة<br><span class='text-white/70'>التصنيع</span>", "story-d1": "مصنعنا مجهز بخطوط إنتاج آلية متقدمة. نحن ندمج الهندسة الدقيقة مع التصنيع السريع لتقديم حلول الصلب المدرفل على البارد التي تحدد معايير الصناعة.",
    ...
    fr: {
        ...
        "coop-subtitle": "Partenariat & Croissance", "coop-title": "Coopération<br><span class='text-white/80'>Commerciale</span>", "coop-desc": "Collaboration avec des entreprises leaders mondiales pour fournir des solutions OEM sur mesure, une logistique supérieure et l'intégration de joints haute résilience.",
        ...
        "stat-worldwide-tag": "Impact Global", "stat-worldwide-title": "Échelle<br><span class='text-white/70'>Mondiale</span>", "stat-worldwide-desc": "L'engagement de Pioneer Metal envers l'excellence industrielle s'étend à tous les coins du globe, offrant une ingénierie de précision à grande échelle.",
    ...
    sq: {
        ...
        "coop-subtitle": "Partneriteti & Rritja", "coop-title": "Bashkëpunim<br><span class='text-white/80'>Biznesi</span>", "coop-desc": "Bashkëpunimi me ndërmarrjet kryesore globalisht për të ofruar zgjidhje OEM të personalizuara, logjistikë superiore dhe integrim të izolimit me rezistencë të lartë.",
        ...
        "stat-worldwide-tag": "Ndikimi Global", "stat-worldwide-title": "Në Shkallë<br><span class='text-white/70'>Botërore</span>", "stat-worldwide-desc": "Angazhimi i Pioneer Metal për përsosmëri industriale arrin në çdo cep të globit, duke ofruar inxhinieri precize në shkallë të gjerë.",
    ...
    sr: {
        ...
        "coop-subtitle": "Partnerstvo i rast", "coop-title": "Poslovna<br><span class='text-white/80'>saradnja</span>", "coop-desc": "Saradnja sa vodećim svetskim preduzećima radi pružanja prilagođenih OEM rešenja, vrhunske logistike i integracije zaptivki visoke otpornosti.",
        ...
        "stat-worldwide-tag": "Globalni uticaj", "stat-worldwide-title": "Širom<br><span class='text-white/70'>sveta</span>", "stat-worldwide-desc": "Posvećenost kompanije Pioneer Metal industrijskoj izvrsnosti seže u svaki kutak sveta, pružajući precizno inženjerstvo u velikom obimu.",
        ...
        "story-t": "Snaga<br><span class='text-white/70'>proizvodnje</span>", "story-d1": "Naša fabrika je opremljena naprednim automatizovanim proizvodnim linijama. Integrišemo precizno inženjerstvo sa brzom proizvodnjom kako bismo pružili hladno valjana čelična rešenja koja definišu industrijske standarde.",
